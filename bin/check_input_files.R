...
#opt$input.file.1<-'/home/bionets-og86asub/Documents/netmap/data/Doc_Spleen_d10.tsv'
#opt$input.file.2<-'/home/bionets-og86asub/Documents/netmap/data/Doc_Spleen_d10.tsv'

data.1<-fread(opt$input.file.1)
data.2<-fread(opt$input.file.2)
